...
from database_setup import Base, Category, Topic, User
...
category1 = Category(name="Personal", description="personal items")

session.add(category1)
session.commit()

Topic1 = Topic(title="When we did that", content="The blablablabal abwer ljr wjej werij weroijweoijer ejjr",
                     summary="currenthththththth")
